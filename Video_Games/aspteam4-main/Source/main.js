...
Install the source code on your platform of choice (you need npm to run it)
run command: "npm install" from source directory
...
Main File: main.js
Main program file is used to define the game objects and run the game loop
